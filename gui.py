...
try:
    ...
    config_valid = False
    print("Cannot open .xml file, will continue without it -->  ",full_xml_filename)
...
if config_valid:
    titles = ['Config Basics', 'User Params', 'Out: Cell Plots', 'Out: Substrate Plots']
    tabs = widgets.Tab(children=[config_tab.tab, user_tab.tab, svg.tab, sub.tab],
                   _titles={i: t for i, t in enumerate(titles)},
                   layout=tab_layout)
else:
    titles = ['Out: Cell Plots', 'Out: Substrate Plots']
    tabs = widgets.Tab(children=[svg.tab, sub.tab],
                   _titles={i: t for i, t in enumerate(titles)},
                   layout=tab_layout)
